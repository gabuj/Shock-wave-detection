...
# Directory paths
input_folder = "creating_cnn/final_images/images"
output_folder = "creating_cnn/final_images/images_sobel"
...
for filename in os.listdir(input_folder):
    if filename.endswith(('.png', '.jpg', '.jpeg')):  # Adjust based on your file types
        ...
        output_image_path = os.path.join(output_folder, f'{os.path.splitext(filename)[0]}.jpg')
